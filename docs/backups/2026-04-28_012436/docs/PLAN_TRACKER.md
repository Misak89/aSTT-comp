...
- owner: engineering
- status: active
- last_updated_utc: 2026-04-27T22:54:21Z
...
- `/benchmark/latemic` umi pilotne nahrat jeden realny browser mic PCM segment a odeslat ho vybranym modelum.
...
- Chybi jeste plny orchestrator pro vice segmentu, opakovani a cele lag budget sweepy; validace zustava amber.
