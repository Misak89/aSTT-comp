...
- MIC sekvence umi volitelne spolecne parametry nad vybranymi modely; kazdy model pouzije pouze podporovane klice.
- Manualni MIC historie i `runtime/mic_sequences/<sequence_token>/report.json` ukladaji `model_params_used` pro audit porovnani.
